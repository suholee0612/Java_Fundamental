...
public class WrapperDemo {
	public static void main(String[] args) {
		...
		// 자바 1.4 이전 버전에서는 primitive data type(PDT)을 Collection에 저장 할 수 없었기 때문에 PDT을 객체화
		...
		// 3. wrapper class => primitive data type(xxxValue())
		int temp = i2.intValue() + i3.intValue(); // auto-unboxig
