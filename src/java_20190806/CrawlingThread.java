...
public class CrawlingThread extends Thread {
	...
	public void run() {
		...
		while (true) {
			Document doc = null;
			String url = "https://coinmarketcap.com/currencies/bitcoin/" + coinName + "/?start=20190101&end=20190806";
			...
			// System.out.println(bodyElements.size()); => 217 출력.
			...
			for (int i = 0; i < bodyElements.size(); i++) {
				...
				// System.out.printf("%s\t%s\t%s\t%s\t%s\t%s\t%s%n", date, open, high, low,
