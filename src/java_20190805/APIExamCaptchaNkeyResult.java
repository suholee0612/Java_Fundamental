...
public class APIExamCaptchaNkeyResult {
	public static void main(String[] args) {
		String clientId = "Yn5Hqp19r5o5DdpCy2zx";// 애플리케이션 클라이언트 아이디값";
		String clientSecret = "_CU3UuzPc4n";// 애플리케이션 클라이언트 시크릿값";
		try {
			String code = "1"; // 키 발급시 0, 캡차 이미지 비교시 1로 세팅
			String key = "oQp4gh6Fe0LRUTdV"; // 캡차 키 발급시 받은 키값
			String value = "F96TH5"; // 사용자가 입력한 캡차 이미지 글자값
